      ...
      <div className="container mx-auto h-full">
        <div className="flex items-center h-full flex-col md:flex-row xl:pb-12">
          <div className="flex-1 flex flex-col items-center xl:items-start xl:pb-6">
            ...
            <h1 className="hidden md:flex text-4xl text-LightText dark:text-DarkText leading-[44px] md:text-5xl md:leading-tight xl:text-7xl xl:leading-[1.2] font-bold md:tracking-[-2px] px-6 xl:px-36">
